...
monthly_data_ui = function(id) {
  ...
  tagList(
    ...
    fluidRow(
      column(width = 4,
        card(style = "overflow: visible; height: auto;",
          card_header("Select Statistic"), 
          card_body(style = "overflow: visible; height: auto;",
            selectizeInput(inputId = ns("month_agg"), label = NULL,
            multiple = FALSE, choices = c("Minimum", "Maximum", "Median", "Mean", "Total"),
            selected = "Mean"))),

       
        card(style = "overflow: visible; height: auto;",
          card_header("Filter Monthly Data"), 
          card_body(style = "overflow: visible; height: auto;",
          ...
          conditionalPanel(
            condition = "input.select_year_m == true", ns = ns, 
          ...
          conditionalPanel(
            condition = "input.select_month_m == true", ns = ns, 
       ...
       card(
         card_header("Download Monthly Data"), 
         card_body( 
    ...
    column(width = 8,
        card(
          card_header(textOutput(ns("monthly_data_heading"))),
          card_body(style = "overflow-y: auto;",
          withSpinner(DT::DTOutput(ns("merged_data_table_m")), type = 5)))
        )
      )
    )
